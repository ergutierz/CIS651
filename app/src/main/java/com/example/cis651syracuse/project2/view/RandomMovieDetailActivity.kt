...
@AndroidEntryPoint
class RandomMovieDetailActivity : AppCompatActivity() {
        ...
        setContent {
            ScreenContainer(
                ...
                onNavItemClick = { screen ->
                    NavUtil.navigateTo(this, Screen.RandomMovie, screen)?.let {
                        startActivity(it)
                    }
                }
            )
    ...
    companion object {
        fun newIntent(context: Context): Intent {
            return Intent(context, RandomMovieDetailActivity::class.java)
        }
    }
}